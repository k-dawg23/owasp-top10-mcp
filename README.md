...
Local **MCP** server (stdio) for **static** repository scans mapped to **OWASP Top 10:2025**. **Product v1.0.0**, **rulepack 2025.1**.
...
**`owasp_scan`** returns structured **JSON** (best for agents). **`owasp_report`** takes the **same arguments** and returns **Markdown** for reading or saving.
